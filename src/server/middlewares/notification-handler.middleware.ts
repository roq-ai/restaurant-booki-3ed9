...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'reservation.create': {
    ...
    key: 'table-reservation-created',
    tenantPath: ['restaurant', 'table', 'reservation'],
    userPath: [],
  },
  'reservation.update': {
    roles: ['owner', 'chef', 'waiter'],
    key: 'table-reservation-updated',
    tenantPath: ['restaurant', 'table', 'reservation'],
    userPath: [],
  },
  'reservation.delete': {
    roles: ['owner', 'chef', 'waiter'],
    key: 'table-reservation-deleted',
    tenantPath: ['restaurant', 'table', 'reservation'],
    userPath: [],
  },
  'menu.create': {
    roles: ['owner', 'chef', 'waiter'],
    key: 'menu-item-created',
    tenantPath: ['restaurant', 'menu'],
    userPath: [],
  },
  'menu.update': {
    roles: ['owner', 'chef', 'waiter'],
